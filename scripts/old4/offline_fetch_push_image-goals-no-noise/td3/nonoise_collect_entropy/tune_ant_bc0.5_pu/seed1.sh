...
--seed=1 \
--description=nonoise_collect_entropy--ta_bc0.5_pu \
--use_td=true \
--reward_loss_type=pu \
...
# --reward_checkpoint_path=/iris/u/khatch/contrastive_rl/results/contrastive_rl_goals11/offline_fetch_push_image-goals-no-noise/reward/nonoise_collect_entropy--ta_pu/seed_0/checkpoints/learner
