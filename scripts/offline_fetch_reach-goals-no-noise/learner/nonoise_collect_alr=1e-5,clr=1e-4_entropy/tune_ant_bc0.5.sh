...
#SBATCH --nodes=1
#SBATCH --job-name="nonoise_collect_alr=1e-5,clr=1e-4_entropy--tune_ant_bc0.5"
#SBATCH --gres=gpu:1
#SBATCH --mem=32G
...
--description=nonoise_collect_alr=1e-5,clr=1e-4_entropy--tune_ant_bc0.5 \
...
--data_load_dir=/iris/u/khatch/contrastive_rl/results/contrastive_rl_goals3/fetch_reach-goals-no-noise/learner/nonoise_collect_alr=1e-5,clr=1e-4_entropy/seed_0/recorded_data
