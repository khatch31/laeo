...
#SBATCH --nodes=1
#SBATCH --job-name="nonoise_collect_entropy--tune_ant_bc1"
#SBATCH --gres=gpu:1
#SBATCH --mem=32G
...
--description=nonoise_collect_entropy--tune_ant_bc1_bce \
--use_td=true \
...
# --reward_checkpoint_path=/iris/u/khatch/contrastive_rl/results/contrastive_rl_goals7/offline_fetch_reach-goals-no-noise/reward/nonoise_collect_entropy--tune_ant_bce/seed_0/checkpoints/learner
