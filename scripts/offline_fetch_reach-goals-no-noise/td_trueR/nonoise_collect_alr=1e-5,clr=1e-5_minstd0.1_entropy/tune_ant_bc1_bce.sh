...
#SBATCH --nodes=1
#SBATCH --job-name="nonoise_collect_alr=1e-5,clr=1e-5_minstd0.1_entropy--tune_ant_bc1"
#SBATCH --gres=gpu:1
#SBATCH --mem=32G
...
--project=contrastive_rl_goals7 \
--env_name=offline_fetch_reach-goals-no-noise \
--description=nonoise_collect_alr=1e-5,clr=1e-5_minstd0.1_entropy--tune_ant_bc1_bce \
--use_td=true \
...
# --reward_checkpoint_path=/iris/u/khatch/contrastive_rl/results/contrastive_rl_goals7/offline_fetch_reach-goals-no-noise/reward/nonoise_collect_alr=1e-5,clr=1e-5_minstd0.1_entropy--tune_ant_bce/seed_0/checkpoints/learner
