...
# --reward_checkpoint_path=/iris/u/khatch/contrastive_rl/results/contrastive_rl_goals9/offline_fetch_reach-goals-no-noise/reward/nonoise_collect_alr=1e-5,clr=1e-5_minstd0.1_entropy--tune_ant_bce/seed_0/checkpoints/learner
