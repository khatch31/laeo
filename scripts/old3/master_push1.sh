...
# BC
# runMultipleSeeds offline_fetch_push-goals-no-noise/bc/nonoise_collect_alr=1e-5,clr=1e-4_minstd0.1_entropy/tune_ant/seed0.sh # Done
# runMultipleSeeds offline_fetch_push-goals-no-noise/bc/nonoise_collect_entropy/tune_ant/seed0.sh
runSingleSeed offline_fetch_push-goals-no-noise/bc/nonoise_collect_entropy/tune_ant/seed0.sh 1
runSingleSeed offline_fetch_push-goals-no-noise/bc/nonoise_collect_entropy/tune_ant/seed0.sh 2
runSingleSeed offline_fetch_push-goals-no-noise/bc/nonoise_collect_entropy/tune_ant/seed0.sh 3
runSingleSeed offline_fetch_push-goals-no-noise/bc/nonoise_collect_entropy/tune_ant/seed0.sh 4

# Learner Goals
runMultipleSeeds offline_fetch_push-goals-no-noise/learner_goals/nonoise_collect_alr=1e-5,clr=1e-4_minstd0.1_entropy/tune_ant_bc0.5/seed0.sh
runMultipleSeeds offline_fetch_push-goals-no-noise/learner_goals/nonoise_collect_entropy/tune_ant_bc0.5/seed0.sh

# TD3 BCE
runMultipleSeeds offline_fetch_push-goals-no-noise/td3/nonoise_collect_alr=1e-5,clr=1e-4_minstd0.1_entropy/tune_ant_bc0.5_bce/seed0.sh
runMultipleSeeds offline_fetch_push-goals-no-noise/td3/nonoise_collect_entropy/tune_ant_bc0.5_bce/seed0.sh
