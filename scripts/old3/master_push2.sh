...
# TD3 PU
# runMultipleSeeds offline_fetch_push-goals-no-noise/td3/nonoise_collect_alr=1e-5,clr=1e-4_minstd0.1_entropy/tune_ant_bc0.5_pu/seed0.sh # Done
runMultipleSeeds offline_fetch_push-goals-no-noise/td3/nonoise_collect_entropy/tune_ant_bc0.5_pu/seed0.sh

# TD3 SARSA BCE
runMultipleSeeds offline_fetch_push-goals-no-noise/td3_sarsa/nonoise_collect_alr=1e-5,clr=1e-4_minstd0.1_entropy/tune_ant_bc0.5_bce/seed0.sh
runMultipleSeeds offline_fetch_push-goals-no-noise/td3_sarsa/nonoise_collect_entropy/tune_ant_bc0.5_bce/seed0.sh

# TD3 SARSA PU
runMultipleSeeds offline_fetch_push-goals-no-noise/td3_sarsa/nonoise_collect_alr=1e-5,clr=1e-4_minstd0.1_entropy/tune_ant_bc0.5_pu/seed0.sh
runMultipleSeeds offline_fetch_push-goals-no-noise/td3_sarsa/nonoise_collect_entropy/tune_ant_bc0.5_pu/seed0.sh
