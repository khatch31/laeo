...
# BC
# runMultipleSeeds offline_fetch_reach-goals-no-noise/bc/nonoise_collect_alr=1e-5,clr=1e-5_minstd0.1_entropy/tune_ant/seed0.sh
# runMultipleSeeds offline_fetch_reach-goals-no-noise/bc/nonoise_collect_entropy/tune_ant/seed0.sh

# Learner Goals
runMultipleSeeds offline_fetch_reach-goals-no-noise/learner_goals/nonoise_collect_alr=1e-5,clr=1e-5_minstd0.1_entropy/tune_ant_bc0.5/seed0.sh
runMultipleSeeds offline_fetch_reach-goals-no-noise/learner_goals/nonoise_collect_entropy/tune_ant_bc0.5/seed0.sh

# TD3 BCE
runMultipleSeeds offline_fetch_reach-goals-no-noise/td3/nonoise_collect_alr=1e-5,clr=1e-5_minstd0.1_entropy/tune_ant_bc0.5_bce/seed0.sh
runMultipleSeeds offline_fetch_reach-goals-no-noise/td3/nonoise_collect_entropy/tune_ant_bc0.5_bce/seed0.sh
