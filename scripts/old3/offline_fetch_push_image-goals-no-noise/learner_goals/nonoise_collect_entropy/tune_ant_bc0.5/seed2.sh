...
# --reward_checkpoint_path=/iris/u/khatch/contrastive_rl/results/contrastive_rl_goals10/offline_fetch_push_image-goals-no-noise/reward/nonoise_collect_entropy--ta_bce/seed_0/checkpoints/learner
