...
#SBATCH --nodes=1
#SBATCH --job-name="nonoise_collect_alr=1e-5,clr=1e-5_minstd0.1_entropy--tune_ant_bc0.5"
#SBATCH --gres=gpu:1
#SBATCH --mem=32G
...
--project=contrastive_rl_goals10 \
--env_name=offline_fetch_reach-goals-no-noise \
--seed=0 \
--description=nonoise_collect_alr=1e-5,clr=1e-5_minstd0.1_entropy--tune_ant_bc0.5_pu \
--use_td=true \
--reward_loss_type=pu \
...
# --reward_checkpoint_path=/iris/u/khatch/contrastive_rl/results/contrastive_rl_goals10/offline_fetch_reach-goals-no-noise/reward/nonoise_collect_alr=1e-5,clr=1e-5_minstd0.1_entropy--tune_ant_pu/seed_0/checkpoints/learner
