...
--seed=0 \
--description=nonoise_collect_entropy--tune_ant_bc0.5_pu \
--use_td=true \
--reward_loss_type=pu \
...
# --reward_checkpoint_path=/iris/u/khatch/contrastive_rl/results/contrastive_rl_goals10/offline_fetch_reach-goals-no-noise/reward/nonoise_collect_entropy--tune_ant_pu/seed_0/checkpoints/learner
