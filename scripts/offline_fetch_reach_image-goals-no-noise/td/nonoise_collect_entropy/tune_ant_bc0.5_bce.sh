...
#SBATCH --nodes=1
#SBATCH --job-name="nonoise_collect_entropy--ta_bc0.5_bce"
#SBATCH --gres=gpu:1
#SBATCH --mem=90G
...
# --reward_checkpoint_path=/iris/u/khatch/contrastive_rl/results/contrastive_rl_goals6/offline_fetch_reach_image-goals-no-noise/reward/nonoise_collect_entropy--ta_bce/seed_0/checkpoints/learner
