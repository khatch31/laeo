...
--env_name=offline_fetch_pushsamelocreset-goals-no-noise \
--seed=0 \
--description=expert_diverse-bc0.5_b256_mse \
--use_gcbc=true \
--mse_bc_loss=true \
...
--data_load_dir=/iris/u/khatch/contrastive_rl/data/fetch/fetch_pushsamelocreset-goals-no-noise/expert_diverse/seed_0/recorded_data
