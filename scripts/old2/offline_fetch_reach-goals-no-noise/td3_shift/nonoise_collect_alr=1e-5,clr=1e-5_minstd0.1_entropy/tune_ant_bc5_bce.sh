...
#SBATCH --nodes=1
#SBATCH --job-name="nonoise_collect_alr=1e-5,clr=1e-5_minstd0.1_entropy--tune_ant_bc5"
#SBATCH --gres=gpu:1
#SBATCH --mem=32G
...
--description=nonoise_collect_alr=1e-5,clr=1e-5_minstd0.1_entropy--tune_ant_bc5_bce \
--use_td=true \
--shift_learned_reward=true \
...
# --reward_checkpoint_path=/iris/u/khatch/contrastive_rl/results/contrastive_rl_goals8/offline_fetch_reach-goals-no-noise/reward/nonoise_collect_alr=1e-5,clr=1e-5_minstd0.1_entropy--tune_ant_bce/seed_0/checkpoints/learner
