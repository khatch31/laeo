...
--description=nonoise_offline_repr64_bc0.05_dim256 \
...
--data_load_dir=/iris/u/khatch/contrastive_rl/results/contrastive_rl_goals/fetch_reach-goals-no-noise/learner/nonoise_collect/seed_0/recorded_data \
--critic_checkpoint_path=/iris/u/khatch/contrastive_rl/results/contrastive_rl_goals/fetch_reach-goals-no-noise/learner/nonoise_collect/seed_0/checkpoints/learner \
...
--project=trash_results \
--env_name=offline_fetch_reach-goals-no-noise \
--description=nonoise_offline_repr64_bc0.05 \
--entropy_coefficient=0 \
--num_actors=0 \
--logdir=/iris/u/khatch/contrastive_rl/results \
