...
#SBATCH --nodes=1
#SBATCH --job-name="offline_tune1_repr1024_bc0.05"
#SBATCH --gres=gpu:1
#SBATCH --mem=32G
...
--env_name=offline_fetch_reach-goals \
--description=offline_tune1_repr1024_bc0.05 \
...
--data_load_dir=/iris/u/khatch/contrastive_rl/results/contrastive_rl_goals/fetch_reach-goals/learner/default_collect/seed_0/recorded_data
