...
--description=nonoise_collect--tune_ant_bc0.5_bce \
--use_td=true \
...
# --reward_checkpoint_path=/iris/u/khatch/contrastive_rl/results/contrastive_rl_goals7/offline_fetch_push-goals-no-noise/reward/nonoise_collect--tune_ant_bce/seed_0/checkpoints/learner
