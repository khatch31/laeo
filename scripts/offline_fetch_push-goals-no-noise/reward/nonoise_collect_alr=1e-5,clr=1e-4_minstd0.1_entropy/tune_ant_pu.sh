...
#SBATCH --nodes=1
#SBATCH --job-name="nonoise_collect_alr=1e-5,clr=1e-4_minstd0.1_entropy--tune_ant_pu"
#SBATCH --gres=gpu:1
#SBATCH --mem=32G
...
--description=nonoise_collect_alr=1e-5,clr=1e-4_minstd0.1_entropy--tune_ant_pu \
--reward_loss_type=pu \
