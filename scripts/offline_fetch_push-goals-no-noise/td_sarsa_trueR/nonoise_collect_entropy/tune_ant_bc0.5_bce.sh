...
# --reward_checkpoint_path=/iris/u/khatch/contrastive_rl/results/contrastive_rl_goals7/offline_fetch_push-goals-no-noise/reward/nonoise_collect_entropy--tune_ant_bce/seed_0/checkpoints/learner
